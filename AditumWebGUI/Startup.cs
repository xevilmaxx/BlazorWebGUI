...
using AditumWebGUI.GrpcServices;
using AditumWebGUI.DTO.Enums;
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapGrpcService<AditumWebGUI.GrpcServices.AuthenticationService>().RequireCors("AllowAll");
